...
from core.views import (
    ...
    # Perfil practicante
    perfil, perfil_editar, sugerencias, sugerencia_cambiar_estado,
...
urlpatterns = [
    ...
    path("sugerencias/<int:sugerencia_id>/estado/", sugerencia_cambiar_estado, name="sugerencia_cambiar_estado"),
